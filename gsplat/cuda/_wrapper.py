...
def rasterize_to_pixels(
    ...
    render_colors, render_alphas, render_normals, render_depths = _RasterizeToPixels.apply(
        means2d.contiguous(),
        conics.contiguous(),
        colors.contiguous(),
...
class _RasterizeToPixels(torch.autograd.Function):
    ...
    def forward(
        ...
        render_colors, render_alphas, render_normals, render_depths, last_ids = _make_lazy_cuda_func(
